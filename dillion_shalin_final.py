...
class Widget:
    def __init__(self):
        ...
        left2 = Message(userFrame, textvariable=self.userText, bg='YELLOW', fg='BLUE')
        left2.config(font=("Black Ops One", 10, 'bold'))
        left2.pack(fill='both', expand='yes')

        compFrame = LabelFrame(root, text="DILLION", font=('Black ops one', 10, 'bold'))
        compFrame.pack(fill="both", expand="yes")

        left1 = Message(compFrame, textvariable=self.compText, bg='BLUE', fg='YELLOW')
        left1.config(font=("Black Ops One", 10, 'bold'))
        left1.pack(fill='both', expand='yes')

        btn = Button(root, text='Start Listening!', font=('Black ops one', 10, 'bold'), bg='YELLOW', fg='BLUE',
                     command=self.clicked).pack(fill='x', expand='no')
        btn2 = Button(root, text='Close!', font=('Black Ops One', 10, 'bold'), bg='Blue', fg='YELLOW',
